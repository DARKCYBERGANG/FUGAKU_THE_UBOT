...
NO_ADMIN = "`I am not an admin lol`"
NO_PERM = "`I don't have sufficient permissions! sed lyf. Alexa play bekhayali`"
NO_SQL = "`Running on Non-SQL mode For Now!`"
...
async def promote(promt):
    ...
    await promt.edit("`making selected user an admin`")
...
async def ban(bon):
    ...
    await bon.edit("`giving a big slap of ban...`")
