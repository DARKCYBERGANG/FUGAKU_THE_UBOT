...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        message_to_reply = f"**My Master is AFK** ! \n\n**Reason** : `{reason}` \n\n**Afk Since** : {afk_since}" + \
            f"\n\n__❗**Be Patient and leave a message**❗__  \n\n ⚠️⚠️ Don't Spam ⚠️⚠️ \n\n**He Will Reply To You Soon ! :)**" \
            if reason \
            else f"**Hello,My Master Is AFK Right Now And May Be Forgot List Reason ! Well, He Will Come Back Soon :) !**"
