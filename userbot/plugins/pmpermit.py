...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/0c9a5ff2bd4fb294fe791.jpg"
else:
...
CUSTOM_MIDDLE_PMP = str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "**BE PATIENT !!**`"
...
USER_BOT_NO_WARN = ("`Hello ! This is` **F.U.G.A.K.U**\n"
                    "`You are now in my master's personal chat💬`\n\n"
                    "**Currently My Master** "
                    f"{DEFAULTUSER} is Busy! \n I cannot Allow You TO Message \n Without My Master's Permission📛📛 \n So Better Don't trynna Spam my master's Inbox 🚫!\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    "⚠️**Otherwise you will be Blocked⚠️**")
