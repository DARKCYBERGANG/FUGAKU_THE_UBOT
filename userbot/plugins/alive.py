...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "@Fugaku_Support_Group"
...
async def amireallyalive(alive):
    ...
    if ALV_PIC:
        ...
        await alive.delete()
        return
    req = requests.get("https://telegra.ph/file/10bf70ca1eec87ab3025b.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(alive.chat_id, f"**Welcome To TeleBot **\n\n"
                ...
                "    [✨ GitHub Repository ✨](https://github.com/DARKCYBERGANG/FUGAKU_THE_UBOT)", link_preview = False)
